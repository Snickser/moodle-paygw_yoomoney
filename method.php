...
$PAGE->set_url('/payment/gateway/yoomoney/method.php', $params);
$string = get_string('payment', 'paygw_yoomoney');
...
$templatedata->image = $OUTPUT->image_url('img', 'paygw_yoomoney');

echo $OUTPUT->render_from_template('paygw_yoomoney/method', $templatedata);
