...
$string['gatewaydescription'] = 'ЮMoney — ваше личное финансовое пространство. Перевод с карты может облагаться вашим банком дополнительной комиссией.';
$string['yoomoneynote'] = 'Перевод с карты может облагаться вашим банком дополнительной комиссией, убедитесь что на счёте вашей карты имеется достаточно средств, иначе перевод не будет успешно завершён.';
...
$string['pluginname_desc'] = 'Плагин позволяет получать переводы через YooMoney.';
