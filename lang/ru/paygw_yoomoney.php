...
$string['yoomoneynote'] = 'Перевод с карты может облагаться вашим банком дополнительной комиссией, убедитесь что на счёте вашей карты имеется достаточно средств, иначе перевод не будет успешно завершен.';
