...
$string['gatewaydescription'] = 'YooMoney is your personal financial space. Transfers from a card may be subject to additional fees from your bank.';
$string['yoomoneynote'] = 'Transfers from a card may incur an additional fee from your bank, please make sure that there are sufficient funds on your card account, otherwise the transfer will not be successful.';
