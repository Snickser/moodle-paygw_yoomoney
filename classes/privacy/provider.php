...
/**
 * Privacy Subsystem implementation for paygw_yoomoney.
 *
...
namespace paygw_yoomoney\privacy;
...
class provider implements \core_privacy\local\request\data_provider, paygw_provider, \core_privacy\local\metadata\provider {
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_external_location_link(
            'yoomoney.plus',
            [
                'shopid'   => 'privacy:metadata:paygw_yoomoney:shopid',
                'apikey'   => 'privacy:metadata:paygw_yoomoney:apikey',
                'email'    => 'privacy:metadata:paygw_yoomoney:email',
            ],
            'privacy:metadata:paygw_yoomoney:yoomoney_plus'
        );

        // The paygw_yoomoney has a database table that contains user data.
        $collection->add_database_table(
            ...
            'privacy:metadata:paygw_yoomoney:paygw_yoomoney'
        );
        return $collection;
    }
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_yoomoney');
        $record = $DB->get_record('paygw_yoomoney', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_yoomoney', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
